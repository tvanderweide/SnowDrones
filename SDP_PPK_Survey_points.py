...
"""
Update Snow Depth Probe Survey points with PPK position output from RTKLIB
...
def process():
    ...
    main_fold = 'C:/Users/Endure1/Documents/JCMSDP/2021-01-15/'
    csv_fn = 'LOG10.txt'
    survey_pts_fn =  main_fold + csv_fn
    ppk_pos_fn = main_fold + 'GPSLogs/raw_202101082038_First/raw_202101082038.pos'

    #Load the Files
    print('Loading: %s' % survey_pts_fn)
    survey_pts = pd.read_csv(survey_pts_fn, sep=",")
